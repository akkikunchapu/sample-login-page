...
razorpay_key_id =""
razorpay_key_secret =""
clinet =razorpay.client(auth=(razorpay_key_id,razorpay_key_secret))
verifyotp = "0" 
...
def cartpage():
    ...
    try:
        ...
        return render_template("cart.html",data=rows,grandtotal=subtotal)
...
def sucess():
    ...
    dict1 ={
        'azorpay_order_id' : order_id,
        'razorpay_payment_id' : payment_id,
        'razorpay_signature' : signature
    }
    try:
        clinet.utility.verify_payment_signature(dict1)
        return "Payment Sucessfull"
    except:
        return "Payment Un sucessfull "
